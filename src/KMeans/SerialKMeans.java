...
import oneDimensionalSampleSpace.Cluster1D;
...
public class SerialKMeans {
	...
	public SerialKMeans(ArrayList<DataPoint1D> dataset,	  Class<?> kAvgClass, int numborOfClasses, double tolerance) throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		super();
